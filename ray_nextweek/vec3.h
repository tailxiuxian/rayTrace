...
public:
	...
	inline const CVec3& operator+(float k) const { return CVec3(value[0] + k, value[1] + k, value[2] + k); }
	inline CVec3 operator-() const { return CVec3(-value[0], -value[1], -value[2]); }
	inline CVec3 operator-(float k) const { return CVec3(value[0] - k, value[1] - k, value[2] - k); }
